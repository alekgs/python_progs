...
def print_given(*args, **kwargs) -> None:
    """Принимает произвольное количество позиционных и именованных аргументов и 
       выводит все переданные аргументы, указывая тип каждого
    """
    [print(a, type(a)) for a in args]
    [print(n, k, type(k)) for n, k in sorted(kwargs.items())]
