"""
Ураган Эндрю, обрушившийся на Флориду 24 августа 1992 года, был одним из самых дорогостоящих и смертоносных
...
# в одну строку
# print(__import__('datetime').date(1992, 8, 24).weekday())
