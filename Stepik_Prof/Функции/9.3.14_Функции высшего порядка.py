...
Дополните приведенный ниже код, чтобы он вывел сумму квадратов всех двузначных чисел из данного списка,
...
print(sum(map(lambda x: x * x, filter(lambda x: abs(x) // 10 in range(1, 10) and not x % 9, numbers))))
