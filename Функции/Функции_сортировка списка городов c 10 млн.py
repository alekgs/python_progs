...
cities = filter(lambda x: (False, x)[x[1] > 10000000 and 'primary' in x], data)
print('Cities:', reduce(lambda x, y: x + ", " + y, sorted(map(lambda x: x[0], cities))))

# но проще так )
# print(f'Cities: ' + ', '.join([i[0] for i in sorted(cities)]))
